...
מודול הליבה ברכיב הליבה 360 טלפון N6 Pro V096 מאפשר לתוקף להשתמש בפקודה 3235427072 כדי להזרים ארגומנטים שתוכננו בקפידה דרך ארגומנט ה- ioctl במכשיר `/dev/block/mmcblk0rpmb` ולגרום ל גרעין לקרוס.
